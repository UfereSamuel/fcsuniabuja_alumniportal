...
@section('breadcrumb')
    ...
    <li>
        <div class="flex items-center">
            <i class="fas fa-chevron-right text-gray-400 mr-1"></i>
            <span class="ml-1 text-sm font-medium text-gray-500">Email</span>
        </div>
    </li>
@endsection

@section('page-title', 'Email Settings')
@section('page-description', 'Configure SMTP settings, email templates, and notification preferences')
...
@section('page-actions')
    ...
    <button type="submit" form="email-form" class="bg-fcs-primary hover:bg-fcs-light-blue text-white px-6 py-3 rounded-lg font-semibold transition shadow-md">
...
@section('content')
    ...
    <!-- Form -->
    <form id="email-form" action="{{ route('admin.settings.update-email') }}" method="POST" class="space-y-6">
        @csrf
