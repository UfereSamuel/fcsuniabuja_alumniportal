...
@section('breadcrumb')
    ...
    <li>
        <div class="flex items-center">
            <i class="fas fa-chevron-right text-gray-400 mr-1"></i>
            <span class="ml-1 text-sm font-medium text-gray-500">Content</span>
        </div>
    </li>
@endsection

@section('page-title', 'Content Settings')
@section('page-description', 'Manage homepage content, about pages, and static text across the website')
...
@section('page-actions')
    ...
    <button type="submit" form="content-form" class="bg-fcs-primary hover:bg-fcs-light-blue text-white px-6 py-3 rounded-lg font-semibold transition shadow-md">
...
@section('content')
    ...
    <!-- Form -->
    <form id="content-form" action="{{ route('admin.settings.update-content') }}" method="POST" class="space-y-6">
        @csrf
