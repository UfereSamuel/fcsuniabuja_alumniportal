...
@section('breadcrumb')
    ...
    <li>
        <div class="flex items-center">
            <i class="fas fa-chevron-right text-gray-400 mr-1"></i>
            <span class="ml-1 text-sm font-medium text-gray-500">Branding</span>
        </div>
    </li>
@endsection

@section('page-title', 'Branding Settings')
@section('page-description', 'Customize your organization\'s visual identity, logos, and color scheme.')
...
@section('page-actions')
    ...
    <button type="submit" form="branding-form" class="bg-fcs-primary hover:bg-fcs-light-blue text-white px-6 py-3 rounded-lg font-semibold transition shadow-md">
...
@section('content')
    <!-- Form -->
    <form id="branding-form" action="{{ route('admin.settings.update-branding') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <!-- Reset Button (separate from main form) -->
        <div class="flex justify-start">
            <form action="{{ route('admin.settings.reset') }}" method="POST" class="inline"
                ...
                <button type="submit" class="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-semibold transition shadow-md">
