...
<head>
    ...
    <title>Edit Slider - FCS Admin Panel</title>
...
<body class="bg-gray-50">
                ...
                <div class="flex items-center">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Edit Slider</p>
                        </div>
                    </a>
                </div>
    ...
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-2">Update the slider information and settings.</p>
        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Enter a description that will appear on the slide">{{ old('description', $slider->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            <img src="{{ asset('storage/' . $slider->image) }}" alt="Current slider image" class="image-preview">
                        </div>
                    </div>
                    @endif
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-1">
                            {{ $slider->image ? 'Replace Image (Optional)' : 'Slider Image *' }}
                        </label>
                        <input type="file" name="image" id="image" accept="image/*" {{ !$slider->image ? 'required' : '' }}
                        ...
                        <div id="image-preview-container" class="mt-4 hidden">
                            ...
                            <img id="image-preview" class="image-preview" alt="New image preview">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $slider->sort_order) }}" required min="0"
            ...
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                ...
                <div class="bg-white rounded-lg p-6 shadow-sm">
                    <div class="text-center">
                        <h4 class="text-2xl font-bold text-gray-900 mb-2" id="preview-title">{{ $slider->title ?: 'Your Title Will Appear Here' }}</h4>
                        <p class="text-gray-600 mb-4" id="preview-description">{{ $slider->description ?: 'Your description will appear here as a subtitle' }}</p>
                        <div id="preview-button" class="{{ $slider->button_text ? '' : 'hidden' }}">
                            <span class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg font-medium">
                                <span id="preview-button-text">{{ $slider->button_text ?: 'Button Text' }}</span>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    <!-- JavaScript for Image Preview and Live Updates -->
    <script>
        ...
        document.getElementById('title').addEventListener('input', function() {
            ...
            preview.textContent = this.value || 'Your Title Will Appear Here';
        });

        document.getElementById('description').addEventListener('input', function() {
            const preview = document.getElementById('preview-description');
            preview.textContent = this.value || 'Your description will appear here as a subtitle';
        });

        document.getElementById('button_text').addEventListener('input', function() {
            const preview = document.getElementById('preview-button-text');
            const container = document.getElementById('preview-button');
