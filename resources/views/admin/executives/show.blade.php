...
<head>
    ...
    <title>{{ $executive->name }} - FCS Admin Panel</title>
                ...
                <div class="flex items-center">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500">Executive Details</p>
                        </div>
                    </a>
                </div>

                <div class="flex items-center space-x-4">
                    <a href="{{ route('admin.executives.edit', $executive) }}" class="text-gray-600 hover:text-blue-600 transition">
                        <i class="fas fa-edit mr-1"></i>Edit Executive
                    </a>
