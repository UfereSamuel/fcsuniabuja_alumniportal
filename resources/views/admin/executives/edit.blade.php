...
@section('title', 'Edit Executive - ' . $executive->name)
...
@section('breadcrumb')
    ...
    <li>
        <div class="flex items-center">
            <i class="fas fa-chevron-right text-gray-400 mr-1"></i>
            <a href="{{ route('admin.executives.show', $executive) }}" class="ml-1 text-sm font-medium text-gray-500 hover:text-fcs-blue">{{ $executive->name }}</a>
        </div>
    </li>
    <li>
        <div class="flex items-center">
...
@section('page-title', 'Edit Executive')
@section('page-description', 'Update executive information, position details, and contact information.')

@section('page-actions')
    <a href="{{ route('admin.executives.show', $executive) }}" class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold transition shadow-md">
        <i class="fas fa-eye mr-2"></i>View Executive
    </a>
    <button type="submit" form="executive-form" class="bg-fcs-primary hover:bg-fcs-light-blue text-white px-6 py-3 rounded-lg font-semibold transition shadow-md">
...
@section('content')
    <div class="flex justify-between items-start mb-6">
        ...
        <div class="bg-blue-50 rounded-lg p-4 border border-blue-200 min-w-64 ml-auto">
    ...
    <!-- Form -->
    <form id="executive-form" action="{{ route('admin.executives.update', $executive) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="date" name="term_start" id="term_start" value="{{ old('term_start', $executive->term_start?->format('Y-m-d')) }}"
